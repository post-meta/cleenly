...
import { PHONE_DISPLAY, PHONE_SMS_HREF, SITE_URL } from "@/lib/constants";

export const metadata: Metadata = {
  title: "Page Not Found | CLEENLY",
  description: "The page you're looking for doesn't exist. Book house cleaning in Seattle online or text us.",
    ...
    <main className="flex min-h-[70vh] items-center justify-center px-6 py-20">
      <div className="max-w-xl text-center">
        ...
        <p className="text-lg text-muted-foreground mb-8">
          ...
          Get a price for your cleaning, or text us directly.
        </p>
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <Button size="lg" variant="secondary" asChild>
            <a href={PHONE_SMS_HREF}>Text {PHONE_DISPLAY}</a>
          </Button>
        </div>
