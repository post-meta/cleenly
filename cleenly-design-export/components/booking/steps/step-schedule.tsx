  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="flex gap-3 overflow-x-auto pb-4 hide-scrollbar snap-x md:grid md:grid-cols-7 md:gap-2 md:pb-0">
          {dates.map(({ dateString, dayName, dayNum, month }) => (
            <button
              ...
              className={cn(
                "flex flex-col items-center justify-center rounded-lg border p-2 transition-all shrink-0 snap-center min-w-[64px] min-h-[72px] md:min-w-0 md:min-h-0",
            ...
            >
              ...
              <span className="text-lg font-semibold leading-none my-0.5">{dayNum}</span>
