...
export const services: ServiceData[] = [
    ...
    },
    {
        ...
        faqs: [
            ...
            },
            {
                ...
                answer: 'Regular cleaning maintains surfaces. Deep cleaning tackles buildup — inside appliances, baseboards, ceiling fans, and areas that get skipped during routine cleaning. Your first visit is always priced as a deep clean; ongoing recurring visits are lighter and cost less.',
            },
            {
    ...
    },
    {
        ...
        longDescription: 'Start fresh in your new home with our comprehensive Move-In Cleaning service. We sanitize every surface, clean inside cabinets and appliances, and ensure your new space is clean and ready for your family.',
        priceRange: "$380-$1,295",
        priceMin: 380,
        priceMax: 1295,
        priceFrom: "$280",
    ...
    },
    {
        ...
        longDescription: 'Transform chaotic spaces into organized havens. Our organizers help you declutter, sort, and implement systems that make it easy to stay organized. Perfect for closets, pantries, playrooms, and garages.',
        priceRange: "$140-$260",
        priceMin: 140,
        priceMax: 260,
        duration: "2-4 hours",
    ...
    },
    {
        ...
        category: "Deep Clean + Damp-Season Protocol",
        isClimateTier: true,
        shortDescription: "A full deep cleaning plus the damp-season protocol. October to March, Seattle homes fight water — we add the mold and mildew work generic deep cleans miss.",
        longDescription: "A full deep cleaning plus the damp-season protocol. October to March, Seattle homes fight water. On top of the complete deep clean, we treat mold colonies behind toilets, mildew at window seals, mud captured in entry-point fibers, and the slow rot that starts where caulking meets ceramic.",
        priceRange: "$285-$535",
        priceMin: 285,
        priceMax: 535,
        priceFrom: "$285",
    ...
    },
    {
        ...
        category: "Deep Clean + Pollen Protocol",
        isClimateTier: true,
        shortDescription: "A full deep cleaning plus the pollen protocol. March to June, PNW spring brings a quiet invasion — we pull pollen out instead of redistributing it.",
        longDescription: "A full deep cleaning plus the pollen protocol. March to June, the lush PNW spring brings a quiet invasion. On top of the complete deep clean, we run HEPA-filtration vacuuming, a surface dust protocol, return-air vent attention, and a fabric refresh to pull pollen out of the home rather than redistributing it.",
        priceRange: "$295-$545",
        priceMin: 295,
        priceMax: 545,
        priceFrom: "$295",
